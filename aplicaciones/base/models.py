...
class Categoria(ModeloBase):
    ...
    imagen_referencial=models.ImageField('', upload_to='categoria/')
...
class Autor(ModeloBase):
    ...
    imagen_referencial=models.ImageField('Imágen Referencial', null=True, blank=True, upload_to='autores/')
...
class Post(ModeloBase):
    ...
    imagen_referencial=models.ImageField('Imágen Referencial', upload_to='imagenes/', max_length=255)
...
class Web(ModeloBase):
    ...
    telefono=models.CharField('Teléfonos', max_length=10)
    email=models.EmailField('Correo Electrónico', max_length=200)
